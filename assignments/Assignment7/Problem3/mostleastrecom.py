...
(toprecommendation, botrecommendations) = getRecommendations(prefs, '484')
print 'The top 5 recommendations for user 484 are:'
print str(toprecommendation[0]) + '\n' + str(toprecommendation[1]) + '\n' + str(toprecommendation[2]) + '\n' + str(toprecommendation[3]) + '\n' + str(toprecommendation[4]) + '\n'
print 'The bottom 5 recommendations for user 484 are:'
print str(botrecommendations[0]) + '\n' + str(botrecommendations[1]) + '\n' + str(botrecommendations[2]) + '\n' + str(botrecommendations[3]) + '\n' + str(botrecommendations[4]) + '\n'